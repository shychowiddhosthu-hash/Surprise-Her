...
function initializeDefaultSettings() {
    ...
    // Local/offline override. Edit LOCAL_CUSTOMIZATION in index.html only.
    if (window.LOCAL_CUSTOMIZATION) {
        const local = window.LOCAL_CUSTOMIZATION;
        window.settings = {
            ...window.settings,
            ...local,
            pages: Array.isArray(local.pages) ? local.pages : window.settings.pages
        };
    }
